...
# Pamir AI Keyinput DKMS Debian Package Builder
# This script builds a Debian package for the Pamir AI keyinput DKMS modules
...
show_results() {
    ...
    print_info "  ls -la /boot/firmware/overlays/pamir-ai-keyinput.dtbo"
}
